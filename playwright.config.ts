...
export default defineConfig({
  ...
  /*
   * Reporters:
   * - list: readable lines in the terminal for each step
   * - html: open with `npx playwright show-report` — includes grouped steps & attachments
   * - github: job summary when CI=true
   */
